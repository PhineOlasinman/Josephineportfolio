...
// ✅ Optional: Get user name from session
...
<head>
  ...
  <style>
    * {
    ...
    body {
      background: url("download (3).jpg") no-repeat center center fixed;
...
<body>
  <nav class="navbar">
    <ul>
      ...
      <li><a href="logout.php" id="loginBtn">LOGOUT (<?php echo $user_name; ?>)</a></li>
    </ul>
  </nav>
  ...
  <footer>
    © 2025 Josephine S. Olasiman | All Rights Reserved
  </footer>
